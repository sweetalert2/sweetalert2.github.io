export function Sponsors() {
  return (
    <>
      ...
      <div className="sponsors" style={{ marginTop: '-1.8em' }}>
        <div>
          <a
      ...
      <div className="sponsors">
        ...
        <div>
          <a href="https://aeroescorts.com/" target="_blank" rel="noopener" aria-label="AeroEscorts">
            <img src="/images/sponsors/aeroescorts.png" alt="AeroEscorts" />
            <br />
            AeroEscorts
          </a>
        </div>
        ...
        <div>
          <a href="https://dreamlovedoll.com/" target="_blank" rel="noopener" aria-label="DreamLoveDoll">
            <img src="/images/sponsors/dreamlovedoll.jpg" alt="DreamLoveDoll" />
            <br />
            DreamLoveDoll
          </a>
        </div>
        ...
        <div>
          ...
          >
            <img src="/images/sponsors/blowupdollshop.png" alt="Inflatable sex doll" />
            <br />
            Inflatable sex doll
          </a>
        </div>
        ...
        <div>
          <a href="https://sexydollies.com/" target="_blank" rel="noopener" aria-label="porn sexdoll">
            <img src="/images/sponsors/sexydollies.png" alt="porn sexdoll" />
            <br />
            porn sexdoll
          </a>
        </div>
        <div>
          <a href="https://bululusexdoll.com/" target="_blank" rel="noopener" aria-label="cheap sex doll">
            <img src="/images/sponsors/bululusexdoll.png" alt="cheap sex doll" />
            <br />
            cheap sex doll
          </a>
        </div>
        <div>
          <a href="https://bululu.shop/" target="_blank" rel="noopener" aria-label="BULULU">
            <img src="/images/sponsors/bululu.png" alt="BULULU" />
            <br />
            BULULU
          </a>
        </div>
