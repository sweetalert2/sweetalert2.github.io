...
var html = (await __vitePreload(async () => {
	const { default: __vite_default__ } = await import("./sidebars-drawers-html-DPLB8GMx.js");
	return { default: __vite_default__ };
}, [])).default;
var src = (await __vitePreload(async () => {
	const { default: __vite_default__ } = await import("./sidebars-drawers-src-UuThw7-I.js");
	return { default: __vite_default__ };
}, [])).default;
function Recipe() {
