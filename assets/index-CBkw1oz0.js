...
function Kinsta() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "kinsta-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://kinsta.com/?kaid=VFCIYHOSRAIN", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: `/images/kinsta/lg/${String(Math.floor(Math.random() * 32) + 1).padStart(2, "0")}.png` }) }) });
}
...
export { DocSearch as D, Kinsta as K, Nav as N, ReactDOM as R, Swal as S, React as a, examples as e, getDefaultExportFromCjs as g, jsxRuntimeExports as j, reactExports as r };
