...
const styles = (await __vitePreload(() => import('./crop-image-styles-CMR7yiwP.js'),true?__vite__mapDeps([]):void 0)).default;
const src = (await __vitePreload(() => import('./crop-image-src-wjtf5nDo.js'),true?__vite__mapDeps([]):void 0)).default;
function Recipe() {
