...
const html = (await __vitePreload(() => import('./validation-message-custom-icon-html-CLE7f6In.js'),true?__vite__mapDeps([]):void 0)).default;
const styles = (await __vitePreload(() => import('./validation-message-custom-icon-styles-DFS6maJi.js'),true?__vite__mapDeps([]):void 0)).default;
const src = (await __vitePreload(() => import('./validation-message-custom-icon-src-EOPSxLkf.js'),true?__vite__mapDeps([]):void 0)).default;
function Recipe() {
