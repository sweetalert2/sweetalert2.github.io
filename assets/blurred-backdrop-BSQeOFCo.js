...
var styles = (await __vitePreload(async () => {
	const { default: __vite_default__ } = await import("./blurred-backdrop-styles-IKWLogX5.js");
	return { default: __vite_default__ };
}, [])).default;
var src = (await __vitePreload(async () => {
	const { default: __vite_default__ } = await import("./blurred-backdrop-src-zjZegYBv.js");
	return { default: __vite_default__ };
}, [])).default;
function Recipe() {
